...
# Test data performance
print("Test Precision:",precision_score(rs.predict(X_test), y_test))
print("Test Recall:",recall_score(rs.predict(X_test), y_test))
print("Test ROC AUC Score:",roc_auc_score(rs.predict(X_test), y_test))
